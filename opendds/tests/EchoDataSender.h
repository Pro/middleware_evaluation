// -*- C++ -*-
//
#ifndef ECHODATASENDER_LISTENER_IMPL
#define ECHODATASENDER_LISTENER_IMPL
...
public:
    ...
    virtual ~EchoDataSenderImpl (void);
...
#endif /* ECHODATASENDER_LISTENER_IMPL  */
